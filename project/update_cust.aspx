<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update_cust.aspx.cs" Inherits="update_cust" %>
                                    ...
                                    <div class="card" style="background-color: rgba(255, 255, 255,0.4)">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <asp:TextBox ID="Txtcmobno" runat="server" MaxLength="10"></asp:TextBox><br />
