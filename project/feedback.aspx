...
<body class="font" >
    ...
    <div>
     <div class="bg-img text-white" align="center">
            ...
            <h2>Feedback</h2><br />_______<br /><h3>Star Hotel</h3>
  ...
  <div class="card" style="background-color:rgba(255, 255, 255,0.4)" >
                 ...
                 <h2 class="text-center link1">Feeback Form</h2>
...
<asp:Label ID="LblFeedback" runat="server" Text="Feedback"></asp:Label><br />
      <asp:TextBox ID="TxtFeedback" runat="server" TextMode="MultiLine"></asp:TextBox><br />
<asp:Button ID="BtnSubmit" runat="server" Text="Submit" OnClick="BtnSubmit_Click"  />
   ...
   <asp:Button ID="Btndelete" runat="server" Text="Delete" OnClick="Btndelete_Click"/>
        ...
        <asp:HiddenField ID="hffeedback" runat="server"  /> 
         <!----------------------------------------------------------------->
        ...
        <asp:Label ID="Lblmsg" runat="server" ></asp:Label>
           ...
           <!----------******************** Gridview code **********************************************--------->
              ...
              <b> 
              <asp:GridView ID="gvfeedback" runat="server" AutoGenerateColumns="false" AutoGenerateSelectButton="true" OnSelectedIndexChanged="gvfeedback_SelectedIndexChanged"  >
             <Columns>
